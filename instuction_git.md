...
Если принаписании коммита на рууском языке нет возможности поставить заглавную букву следует закрыть VSCode, преключиться на английский язык и сново запусть VSCode, после запустить терминал.